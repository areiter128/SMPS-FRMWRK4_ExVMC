                    ...
                    unsigned int accumulator_catastrophic_overflow_trap_enable)
{
    ...
    INTCON1bits.OVATE = accumulator_a_overflow_trap_enable; // Enable Accumulator A Overflow Trap Enable bit
    INTCON1bits.OVBTE = accumulator_b_overflow_trap_enable; // Enable Accumulator B Overflow Trap Enable bit
    INTCON1bits.COVTE = accumulator_catastrophic_overflow_trap_enable; // Enable Catastrophic Overflow Trap Enable bit
